...
def rss_item(pubDate: str, title_raw: str, link: str) -> bytes:
  ...
  try:
    with open(file_name, "r", encoding="utf-8", newline="\n") as f:
      ...
      full_text = xml_escape_bytes(full_text_raw.encode(output_encoding))
  ...
  return f"""    <item>
      ...
      <guid>{link}</guid>
      <description>""".encode(output_encoding) + full_text + b"""</description>
    </item>
"""
...
with open("rss.xml", "wb") as f:
  f.write(rss_header.encode(output_encoding))
    ...
    for i in file:
      ...
      if m:
        try:
          ...
          print(e.args[1])
          print()
  f.write(rss_footer.encode(output_encoding))
